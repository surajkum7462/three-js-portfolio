...
export default function Navbar() {
  ...
  return (
    <nav className="bg-black bg-opacity-90 text-white px-6 py-4 flex justify-between items-center fixed top-0 left-0 w-full z-50 shadow-lg">
      ...
      {/* Desktop Menu */}
      <div className="hidden md:flex space-x-6 text-lg font-medium">
        <Link to="/home-classic" className="hover:text-yellow-400">
          Home
        </Link>
        <Link to="/about-classic" className="hover:text-yellow-400">
          About
        </Link>
        <Link to="/projects-classic" className="hover:text-yellow-400">
          Projects
        </Link>
        <Link to="/blog" className="hover:text-yellow-400">
          Blog
        </Link>
        <Link to="/contact-classic" className="hover:text-yellow-400">
          Contact
        </Link>
        <Link to="/socials-classic" className="hover:text-yellow-400">
          Socials
        </Link>
      </div>
      ...
      {/* Mobile Dropdown */}
      {isOpen && (
        <div className="absolute top-16 left-0 w-full z-40 bg-black bg-opacity-95 flex flex-col items-center space-y-4 py-6 md:hidden text-lg font-medium shadow-md">
          <Link
            to="/"
